...
export const HeroHighlight = ({ children, className, containerClassName }: { children: React.ReactNode; className?: string; containerClassName?: string }) => {
    ...
    return (
        <div
            className={cn("relative h-[40rem] flex items-center bg-gradient-to-t from-default-50 justify-center w-full group", containerClassName)}
...
export const Highlight = ({ children, className }: { children: React.ReactNode; className?: string }) => {
    return (
        <motion.span
            ...
            className={cn(`relative inline-block pb-1 px-1 rounded-lg bg-gradient-to-r from-purple-300 to-purple-300 dark:from-purple-500 dark:to-purple-500`, className)}
        >
            {children}
        </motion.span>
    );
